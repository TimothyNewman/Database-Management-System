...
public class Database implements AutoCloseable {
    ...
    void lockTableMetadata(String tableName, LockType lockType) {
        ...
        if (mayNeedToCreate) {
            ...
            LockUtil.ensureAncestors(getTableInfoContext(), LockType.X);
    ...
    void lockIndexMetadata(String indexName, LockType lockType) {
        ...
        if (mayNeedToCreate) {
            ...
            LockUtil.ensureAncestors(getIndexInfoContext(), LockType.X);
    ...
    private class TransactionImpl extends AbstractTransaction {
        ...
        public void dropTable(String tableName) {
            ...
            try {
                ...
                LockUtil.ensureSufficientLockHeld(getTableContext(tableName, record.partNum), LockType.X);
